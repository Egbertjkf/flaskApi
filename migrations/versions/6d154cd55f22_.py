...
Revision ID: 6d154cd55f22
Revises: 
Create Date: 2021-01-22 08:20:37.738798
...
def upgrade():
    ...
    sa.Column('dt_altera', sa.String(length=10), nullable=True),
    ...
    sa.PrimaryKeyConstraint('nr_pedido', 'nr_sequen')
    )
    ...
    sa.Column('ds_obersv', sa.String(length=250), nullable=True),
    sa.Column('fl_status', sa.String(length=1), nullable=True),
